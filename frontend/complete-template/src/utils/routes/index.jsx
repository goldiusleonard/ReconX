...
const PaymentMethodsPage = withLazyLoadably(lazy(() => import('@/pages/editProfile/PaymentMethods')));
			...
			<ScrollToTopOnRouteChange>
				<Routes>
					...
					<Route path="/" element={<MinimalLayout />}>
					 <Route  path="signin" element={<LoginSimplePage />} /> 
						<Route path="pages/">
					...
					<Route path="/" element={<MainLayout />}>
						...
						<Route path="pages/">
							<Route path="paymentPage" element={<PaymentMethodsPage />} />
